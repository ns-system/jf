<div class="nav nav-pills nav-stacked list-group">
    ...
    <a role="presentation" class="list-group-item collapse" data-toggle="collapse" href="#suisin"><span class="caret"></span> 推<small>進支援システム</small></a><span></span>
    <div class="collapse" id="suisin">@include('admin.sidebar.suisin')</div>
    @endif
...
{{--     @if($auth_user->RosterUser && $auth_user->RosterUser->is_administrator || $auth_user->is_super_user) --}}
    ...
    @if(\App\RosterUser::user($auth_user->id)->exists() && \App\RosterUser::user($auth_user->id)->first()->is_administrator || $auth_user->is_super_user)
        ...
        <div class="collapse" id="roster">@include('admin.sidebar.roster')</div>
    @endif


    @if($auth_user->is_super_user)
        <span class="list-group-item collapse list-divider"></span>
        <a role="presentation" class="list-group-item collapse" data-toggle="collapse" href="#system"><span class="caret"></span> シ<small>ステム設定</small></a>
        <span></span>
