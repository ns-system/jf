<form class="form-inline" role="form" method="GET" action="{{route('admin::super::user::search')}}">
    <div class="form-group"><input type="text" name="name" class="form-control input-sm" value="{{$name}}" placeholder="ユーザー名（姓）"></div>

    <div class="form-group"><input type="text" name="mail" class="form-control input-sm" value="{{$mail}}" placeholder="メールアドレス"></div>
