...
<table class="table table-hover table-small">
  ...
  <tbody>
    ...
    <tr @if($day['holiday'] == true) class="danger" @elseif($day['week'] == 0)   class="danger" @elseif($day['week'] == 6)   class="info" @endif>
      ...
      <td class="va-middle">
        <a href="{{ route_with_query('admin::roster::csv::edit', ['id'=>$r->key_id, 'ym'=>$ym], $search) }}">
          <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 強制変更
        </a>
      </td>
    </tr>
    @endforeach
