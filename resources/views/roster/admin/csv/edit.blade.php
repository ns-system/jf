...
<div class="border-bottom"><h2>勤務データ修正 <small> - {{date('n月j日', strtotime($roster->entered_on))}} {{$user->name}}さん</small></h2></div>
...
<div class="col-md-10 col-md-offset-1">
    <div class="panel panel-primary">
        <div class="panel-heading">
            {{date('n月j日', strtotime($roster->entered_on))}} - {{$user->name}}さん
        </div>
