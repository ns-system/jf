<form method="POST" action="{{route('admin::roster::user::edit', ['id'=>$id])}}">
    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <a data-target="#division" class="text-success text-sm" id="add-division" data-toggle="tooltip" title="複数部署を追加する場合、クリックしてください。" href="">部署を追加する</a>
