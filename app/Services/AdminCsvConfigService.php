...
//                        ['is_daily', '日次']
                ...
                [
                    'row' => [
                        ...
                        ['common_table_name', '共通テーブル名', 'class' => 'text-left small'],
                    ]
                ],
                [
                    'row' => [
                ...
                [
                    'row' => [
                        ...
                        ['is_exist_account_and_deposit', '口座預入', 'class' => 'small text-left'],
...
//                        ['split_foreign_key_4', '分割時キー4', 'class' => 'small text-left'],
            ...
            'table_search'  => [
                ...
                'is_exist_account_and_deposit' => ['column_name' => 'is_exist_account_and_deposit', 'display' => '貯金預入番号', 'type' => 'integer'],
...
//                    '分割時キー4',
            ...
            'import'        => [
                'table_columns' => [
                    ...
                    [1, 'table_name', 'テーブル名',],
                    [1, 'common_table_name', '共通テーブル名',],
                    [1, 'is_cumulative', '累積フラグ',],
                    [1, 'is_account_convert', '口座変換フラグ',],
                    [1, 'is_exist_account_and_deposit', '貯金預入番号フラグ',],
                    [1, 'is_process', '処理フラグ',],
...
//                    'table_name'            => 'required|min:1',
                    ...
                    'is_exist_account_and_deposit' => 'required|boolean',
                ...
                'types'         => [
                    ...
                    'is_exist_account_and_deposit' => 'integer',
                    'is_process'                   => 'integer',
                    'is_split'                     => 'integer',
                ...
                'flags'         => [
                    ...
                    'is_exist_account_and_deposit' => 1,
                    'is_process'                   => 1,
                    'is_split'                     => 1,
                    'is_deposit_split'             => 1,
                    'is_loan_split'                => 1,
