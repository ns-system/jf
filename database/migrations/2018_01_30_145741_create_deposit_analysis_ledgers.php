...
class CreateDepositAnalysisLedgers extends Migration
{

    public $tableName = 'deposit_analysis_ledgers';
    ...
    public function up() {
        Schema::connection($this->connect)->create($this->tableName, function(Blueprint $table) {
            ...
            $table->double("fiscal_year_cumulation_balance");
            $table->double("aim_year_balance_cumulation");
            ...
            $table->char("previous_prefecture_code", 1)->index();
            $table->char("spare_1", 17);
