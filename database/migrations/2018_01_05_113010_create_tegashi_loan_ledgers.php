...
class CreateTegashiLoanLedgers extends Migration
{
     ...
     * @return void
     */
    public $tableName = 'tegashi_loan_ledgers';
    ...
    public function up() {
        Schema::connection($this->connect)->create($this->tableName, function(Blueprint $table) {
            ...
            $table->integer("interest_payment_code")->index();
            ...
            $table->double("past_renewal_amount");
            $table->date("tegashi_last_term_on")->nullable();
            $table->integer("renewal_state")->index();
            $table->integer("renewal_count");
            $table->integer("renewal_repay_date");
            $table->date("renewal_application_term_on")->nullable();
            $table->double("renewal_application_amount");
            $table->date("renewal_bill_term_on")->nullable();
            $table->date("renewal_last_term_on")->nullable();
            $table->float("renewal_interest_rate");
            $table->date("actual_at_first_loaned_on")->nullable();
            $table->integer("renewal_display")->index();
            ...
            $table->integer("security_calculate_condition_state")->index();
            ...
            $table->double("deposit_collateral_fixed_interest");
