...
class CreateLoanManagementLedgers extends Migration
{

    public $tableName = 'loan_management_ledgers';
    ...
    public function up() {
        Schema::connection($this->connect)->create($this->tableName, function(Blueprint $table) {
            ...
            $table->integer("assist_code")->index();
